...
module Saklient
  module Cloud
    module Model
      ...
      class Model_Script < Saklient::Cloud::Model::Model
        ...
        #
        # @param [String] id
        # @return [Saklient::Cloud::Resource::Script] リソースオブジェクト
        def get_by_id(id)
        ...
        #
        # @return [Array<Saklient::Cloud::Resource::Script>] リソースオブジェクトの配列
        def find
          return _find
        end
