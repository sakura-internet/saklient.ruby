...
require_relative '../resources/disk'
...
module Saklient
  module Cloud
    module Models
      ...
      class Model_Disk < Saklient::Cloud::Models::Model
        ...
        def _create_resource_impl(obj, wrapped = false)
          ...
          return Saklient::Cloud::Resources::Disk.new(@_client, obj, wrapped)
        end
        ...
        #
        # @return [Array<Saklient::Cloud::Resources::Disk>] リソースオブジェクトの配列
        def find
          return _find
        end
