...
module Saklient
  module Cloud
    module Models
      ...
      class Model_Archive < Saklient::Cloud::Models::Model
        ...
        def _create_resource_impl(obj, wrapped = false)
          ...
          return Saklient::Cloud::Resources::Archive.new(@_client, obj, wrapped)
        end
        ...
        #
        # @return [Saklient::Cloud::Resources::Archive] リソースオブジェクト
        def create
          return _create
        end
        ...
        #
        # @return [Array<Saklient::Cloud::Resources::Archive>] リソースオブジェクトの配列
        def find
          return _find
        end
