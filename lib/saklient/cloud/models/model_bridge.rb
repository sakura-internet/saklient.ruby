...
module Saklient
  module Cloud
    module Models
      ...
      class Model_Bridge < Saklient::Cloud::Models::Model
        ...
        def _create_resource_impl(obj, wrapped = false)
          ...
          return Saklient::Cloud::Resources::Bridge.new(@_client, obj, wrapped)
        end
        ...
        #
        # @return [Saklient::Cloud::Resources::Bridge] リソースオブジェクト
        def create
          return _create
        end
        ...
        #
        # @return [Array<Saklient::Cloud::Resources::Bridge>] リソースオブジェクトの配列
        def find
          return _find
        end
