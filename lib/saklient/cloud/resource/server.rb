...
module Saklient
  module Cloud
    module Resource
      ...
      class Server < Saklient::Cloud::Resource::Resource
        ...
        # @return [Array<Disk>]
        def find_disks
          model = Saklient::Util::create_class_instance('saklient.cloud.model.Model_Disk', [@_client])
        ...
        def add_iface
          model = Saklient::Util::create_class_instance('saklient.cloud.model.Model_Iface', [@_client])
          res = model.create
        ...
        def set_plan(v)
          ...
          raise Saklient::Errors::SaklientException.new('immutable_field', 'Immutable fields cannot be modified after the resource creation: ' + 'Saklient::Cloud::Resource::Server#plan') if !@is_new
          @m_plan = v
          @n_plan = true
          return @m_plan
        end
        ...
        def api_deserialize_impl(r)
          ...
          if Saklient::Util::exists_path(r, 'ServerPlan')
            @m_plan = (Saklient::Util::get_by_path(r, 'ServerPlan')).nil? ? nil : Saklient::Cloud::Resource::ServerPlan.new(@_client, Saklient::Util::get_by_path(r, 'ServerPlan'))
          else
            @m_plan = nil
            @is_incomplete = true
          end
          ...
          if Saklient::Util::exists_path(r, 'Interfaces')
            if (Saklient::Util::get_by_path(r, 'Interfaces')).nil?
              ...
              for t in Saklient::Util::get_by_path(r, 'Interfaces')
                v2 = nil
                v2 = (t).nil? ? nil : Saklient::Cloud::Resource::Iface.new(@_client, t)
                @m_ifaces << v2
              end
            end
          else
          ...
          if Saklient::Util::exists_path(r, 'Instance')
            @m_instance = (Saklient::Util::get_by_path(r, 'Instance')).nil? ? nil : Saklient::Cloud::Resource::ServerInstance.new(@_client, Saklient::Util::get_by_path(r, 'Instance'))
          else
            @m_instance = nil
            @is_incomplete = true
          end
