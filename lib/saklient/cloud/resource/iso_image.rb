...
module Saklient
  module Cloud
    module Resource
      ...
      class IsoImage < Saklient::Cloud::Resource::Resource
        ...
        def set_size_mib(v)
          Saklient::Util::validate_type(v, 'Fixnum')
          raise Saklient::Errors::SaklientException.new('immutable_field', 'Immutable fields cannot be modified after the resource creation: ' + 'Saklient::Cloud::Resource::IsoImage#size_mib') if !@is_new
          @m_size_mib = v
          @n_size_mib = true
          return @m_size_mib
        end
