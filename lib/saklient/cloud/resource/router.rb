...
module Saklient
  module Cloud
    module Resource
      ...
      class Router < Saklient::Cloud::Resource::Resource
        ...
        # @return [Swytch]
        def get_swytch
          model = Saklient::Util::create_class_instance('saklient.cloud.model.Model_Swytch', [@_client])
          id = get_swytch_id
        ...
        def add_ipv6_net
          ...
          reload
          return Saklient::Cloud::Resource::Ipv6Net.new(@_client, result[:IPv6Net])
        end
        ...
        def add_static_route(maskLen, nextHop)
          ...
          reload
          return Saklient::Cloud::Resource::Ipv4Net.new(@_client, result[:Subnet])
        end
        ...
        def set_network_mask_len(v)
          ...
          raise Saklient::Errors::SaklientException.new('immutable_field', 'Immutable fields cannot be modified after the resource creation: ' + 'Saklient::Cloud::Resource::Router#network_mask_len') if !@is_new
        ...
        def set_band_width_mbps(v)
          Saklient::Util::validate_type(v, 'Fixnum')
          raise Saklient::Errors::SaklientException.new('immutable_field', 'Immutable fields cannot be modified after the resource creation: ' + 'Saklient::Cloud::Resource::Router#band_width_mbps') if !@is_new
          @m_band_width_mbps = v
