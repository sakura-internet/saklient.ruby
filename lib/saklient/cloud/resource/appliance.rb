...
module Saklient
  module Cloud
    module Resource
      ...
      class Appliance < Saklient::Cloud::Resource::Resource
        ...
        def set_clazz(v)
          ...
          raise Saklient::Errors::SaklientException.new('immutable_field', 'Immutable fields cannot be modified after the resource creation: ' + 'Saklient::Cloud::Resource::Appliance#clazz') if !@is_new
          @m_clazz = v
          @n_clazz = true
          return @m_clazz
        end
