...
module Saklient
  module Cloud
    module Resource
      ...
      class ServerInstance < Saklient::Cloud::Resource::Resource
        ...
        def api_deserialize_impl(r)
          ...
          if Saklient::Util::exists_path(r, 'CDROM')
            @m_iso_image = (Saklient::Util::get_by_path(r, 'CDROM')).nil? ? nil : Saklient::Cloud::Resource::IsoImage.new(@_client, Saklient::Util::get_by_path(r, 'CDROM'))
          else
            @m_iso_image = nil
            @is_incomplete = true
          end
