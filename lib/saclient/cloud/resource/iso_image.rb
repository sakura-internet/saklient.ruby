    ...
    module Resource
      ...
      class IsoImage < Saclient::Cloud::Resource::Resource
        ...
        def set_size_mib(v)
          ...
          raise Saclient::Errors::SaclientException.new('immutable_field', 'Immutable fields cannot be modified after the resource creation: ' + 'Saclient::Cloud::Resource::IsoImage#size_mib') if !@is_new
          @m_size_mib = v
          @n_size_mib = true
          return @m_size_mib
        end
